    ...
    <section className="py-16 sm:py-20 bg-[#FAFAFC] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-[#011B4C] text-[#FFFFFF] rounded-2xl p-8 sm:p-10 shadow-xl border border-[#011B4C] flex flex-col justify-between space-y-6">
            ...
            <div className="pt-6 border-t border-white/15 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              ...
              <button
                ...
                className="bg-[#FBAD00] hover:bg-[#d49300] text-[#011B4C] font-bold text-xs uppercase tracking-wider px-5 py-3 rounded-xl shadow transition-colors cursor-pointer text-center"
              >
                {t.hero.cta}
              </button>
            </div>
          ...
          <div className="bg-[#FFFFFF] text-[#011B4C] rounded-2xl p-8 sm:p-10 shadow-lg border border-slate-200 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
            ...
            <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              ...
              <button
                ...
                className="bg-[#011B4C] hover:bg-[#1E2A44] text-[#FFFFFF] font-bold text-xs uppercase tracking-wider px-5 py-3 rounded-xl shadow transition-colors cursor-pointer text-center"
              >
                {t.hero.cta}
              </button>
            </div>
