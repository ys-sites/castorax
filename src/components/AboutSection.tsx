      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            {/* Subtext with FoldText Animation */}
            <RiseUp delay={0.2}>
              <div className="text-base text-[#1E2A44] leading-relaxed font-sans">
                <FoldText
                  text={founder.desc}
                  splitBy="word"
                  trigger="scroll"
              ...
              <RiseUpItem key={idx} className="h-full">
                <div className="bg-[#FAFAFC] border border-slate-200/90 rounded-2xl p-6 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md hover:border-[#011B4C]/30 transition-all h-full hover:-translate-y-1">
                  <div className="space-y-3">
                    ...
                    <div className="text-xs sm:text-sm text-[#1E2A44] leading-relaxed font-sans">
                      <FoldText
                        text={step.desc}
                        splitBy="word"
                        trigger="scroll"
